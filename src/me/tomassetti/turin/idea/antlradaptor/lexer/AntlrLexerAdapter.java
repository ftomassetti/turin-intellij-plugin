// TAKEN FROM https://github.com/antlr/intellij-plugin-v4

package me.tomassetti.turin.idea.antlradaptor.lexer;
...
public abstract class AntlrLexerAdapter<State extends AntlrLexerState> extends com.intellij.lexer.LexerBase {
	/**
	 * Gets the {@link com.intellij.lang.Language} supported by this lexer. This value is passed to {@link ElementTypeFactory} to ensure
	 * the correct collection of {@link com.intellij.psi.tree.IElementType} is used for assigning element types to tokens in
	 * {@link #getTokenType}.
	 */
	 ...
	 *
	 * <p>Due to the way IntelliJ requests token information, the ANTLR {@link org.antlr.v4.runtime.Lexer} is always positioned one token
	 ...
	 * state <em>before</em> the current token, after which {@link org.antlr.v4.runtime.Lexer#nextToken} can be called to obtain
	 * {@link #currentToken}.</p>
	 */
	private State currentState;
	/**
	 * This field tracks the "exposed" lexer token. This is the result of the most recent call to
	 * {@link org.antlr.v4.runtime.Lexer#nextToken} on the underlying ANTLR lexer, and is the source of information for
	...
	/**
	 * Constructs a new instance of {@link AntlrLexerAdapter} with the specified {@link com.intellij.lang.Language} and underlying
	 * ANTLR {@link org.antlr.v4.runtime.Lexer}.
	 *
	...
	/**
	 * Gets the ANTLR {@link org.antlr.v4.runtime.Lexer} used for actual tokenization of the input.
	 *
	 * @return the ANTLR {@link org.antlr.v4.runtime.Lexer} instance
	 */
	...
	/**
	 * Gets the {@link org.antlr.v4.runtime.Token} object providing information for calls to {@link #getTokenStart}, {@link #getTokenType},
	 * etc.
	 *
	 * @return The current {@link org.antlr.v4.runtime.Token} instance.
	 */
	 ...
	 * {@link org.antlr.v4.runtime.Lexer#setInputStream} to set the input stream, followed by {@link AntlrLexerState#apply} to initialize the
